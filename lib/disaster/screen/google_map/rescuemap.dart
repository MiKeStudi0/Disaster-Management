...
class _RescueMapState extends State<RescueMap> {
 ...
 Future<void> _fetchRecuseLocation() async {
  ...
  QuerySnapshot querySnapshot = await firestore.collection('Resucelocations').get();
      ...
      if (lat != 0.0 && lng != 0.0) {
        _markers.add(
          Marker(
            ...
            onTap: () {
              _getDirectionsToPlace(LatLng(lat, lng)); // Add direction route when the marker is tapped
            },
          ),
        );
      }
